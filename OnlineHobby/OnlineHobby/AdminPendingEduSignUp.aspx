<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="AdminPendingEduSignUp.aspx.cs" Inherits="OnlineHobby.AdminPendingEduSignUp" %>
   ...
   <style>
    ...
    <div class="container-fluid bg">
        ...
        <div class="row justify-content-center mt-4 pt-1 mb-3 pb-4 mb-lg-4">
            <asp:Button ID="btnPending" CssClass="buttonHeader" runat="server" Text="Pending" type="submit" Style="width: 50%; height: 40px; background: #e6e6e6;" Font-Size="17px" OnClick="btnPending_Click" BorderStyle="Solid" ForeColor="#F98006" BorderColor="Silver" Font-Bold="True" />
            <asp:Button ID="btnCompleted" CssClass="buttonHeader" runat="server" Text="Completed" type="submit" Style="width: 50%; height: 40px;" Font-Size="17px" OnClick="btnCompleted_Click" BorderStyle="Solid" BorderColor="Silver" />
        </div>

        <div class="alert alert-primary alert-dismissible fade show" runat="server" id="MsgNotice" visible="false">
            <h4 class="alert-heading">Info</h4>
            No pending educator sign up application.
        </div>
        ...
        <div style="padding-left: 15px; padding-bottom: 70px">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT [eduAppId], [eduName], [eduEmail], [courseCategory] FROM [EduApplication] WHERE ([apprStatus] = @apprStatus)">
                <SelectParameters>
