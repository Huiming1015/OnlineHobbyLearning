...
{
    public partial class AdminPendingEduIncident : System.Web.UI.Page
    {
        SqlConnection con;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["AdminId"] != null)
            {
                ...
                con.Open();
                string cmd = "Select * from Complaint where apprStatus=@status";
        ...
        protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("AdminPendingEduIncidentDetails.aspx?id=" + e.CommandArgument.ToString());
            }
        }
