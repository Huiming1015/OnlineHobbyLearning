...
{
    public partial class AdminCompletedEduSignUp : System.Web.UI.Page
    {
        SqlConnection con;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["AdminId"] != null)
            {
                ...
                con.Open();
                string cmd = "Select * from EduApplication where apprStatus=@status or apprStatus=@status2";
        ...
        protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("AdminCompletedEduSignUpDetails.aspx?id=" + e.CommandArgument.ToString());
            }
        }
