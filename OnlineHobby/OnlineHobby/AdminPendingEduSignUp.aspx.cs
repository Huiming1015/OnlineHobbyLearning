...
{
    public partial class AdminPendingEduSignUp : System.Web.UI.Page
    {
        SqlConnection con;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if(Session["AdminId"] != null)
            {
                ...
                con.Open();
                string cmd = "Select * from EduApplication where apprStatus=@status";
                SqlCommand cmdSelect = new SqlCommand(cmd, con);
                cmdSelect.Parameters.AddWithValue("@status", "Pending");
        ...
        protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            {
                Response.Redirect("AdminPendingEduSignUpDetails.aspx?id=" + e.CommandArgument.ToString());
            }
        }
