...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container border border-dark mt-2 mb-2 align-content-center" style="width: 90%; margin-left: 5%; min-height: 600px; font-size: 18px;">
        ...
        <hr />
        <asp:DataList ID="dlCourseInfo" runat="server" DataKeyField="scheduleId" DataSourceID="SqlCourseInfo" Width="100%" CssClass="mt-3 mb-3">
            <ItemTemplate>
                <div class="row text-center d-flex aligns-items-center justify-content-center" style="min-height: 400px;">
                    <div class="col-md-6 border-end">
                        ...
                        <asp:Label ID="lblEnrolStatus" runat="server" Text='<%# Eval("enrolStatus") %>' Visible="false" />
        ...
        <div class="row pe-5 mb-2">
            ...
            <div class="col-md-3 text-end">
                <asp:Button ID="btnWithdraw" runat="server" Text="WITHDRAW" CssClass="btn btn-light btn-lg rounded-pill" Style="height: 47px; width: 220px; background-color: #f98006; color: white" />
            </div>
        </div>
        <br />
    </div>
