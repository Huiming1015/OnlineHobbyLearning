<%@ Page Title="" Language="C#" MasterPageFile="~/NestedProfile.master" AutoEventWireup="true" CodeBehind="Followers.aspx.cs" Inherits="OnlineHobby.Followers" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Body" runat="server">
    ...
    <div class="container-fluid div-background mt-3">
        ...
        <div class="text-center">
            <h2 class="mt-5 pt-3 mb-3 pb-3" style="color: #f98006; font-weight: bold">Followers</h2>
        </div>
                    ...
                    <table style="background-color: rgba(0, 0, 0, 0.03); border-radius: 15px">
                        <tr>
                            ...
                            <td class="auto-style3" rowspan="5">
                                <%--                                <asp:Button ID="btnView" runat="server" CssClass="btn btn-light btn-lg rounded-pill" Text="VIEW" CommandArgument='<%# Eval("studId") %>' CommandName="View" type="submit" Style="height: 40px; width: 110px; background-color: #f98006; color: white" Font-Size="Medium" />--%>
                            </td>
                        ...
                        <tr>
                            ...
                            <td dir="ltr" rowspan="3" class="auto-style6">
                                <asp:Label ID="Label2" runat="server" Font-Size="19px"><%#Eval("studName")%></asp:Label>
                            </td>
                            <td dir="rtl" class="auto-style1"></td>
...
FROM FollowEngagement INNER JOIN Student ON FollowEngagement.studId = Student.studId WHERE FollowEngagement.eduId=@UserId">
            ...
            <div class="container pt-4 pb-5">
                <asp:Label ID="Label10" runat="server" Text="Total Followers: "></asp:Label>
                &nbsp;
            <asp:Label ID="lblFllwerCount" runat="server" Text="-"></asp:Label>
            </div>
        </div>
