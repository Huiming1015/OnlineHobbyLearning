...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="mt-4 mb-4 border" style="width: 90%; margin-left: 5%; min-height: 600px; font-size: 20px">
        ...
        <div class="container w-25 align-content-center">
            ...
            <div class="row">
                <div class="col-12">
                    <asp:TextBox ID="txtCardNum" runat="server" CssClass="form-control" placeholder="4123412341234123"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="*Only Visa and MasterCard are allowed!" ControlToValidate="txtCardNum" Font-Size="Small" ForeColor="Red" ValidationExpression="^(4[0-9]{12}(?:[0-9]{3})?)|(?:4[0-9]{12}(?:[0-9]{3})?|5[1-5][0-9]{14})$" Display="Dynamic"></asp:RegularExpressionValidator>
                </div>
            </div>
            <br />
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="*Expiry date should be MM/YY!" ControlToValidate="txtExpiry" Font-Size="Small" ForeColor="Red" ValidationExpression="^(0[1-9]|1[0-2])\/?([0-9]{4}|[0-9]{2})$" Display="Dynamic"></asp:RegularExpressionValidator>
