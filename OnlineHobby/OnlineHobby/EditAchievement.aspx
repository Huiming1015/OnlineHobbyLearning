<%@ Page Title="" Language="C#" MasterPageFile="~/NestedProfile.master" AutoEventWireup="true" CodeBehind="EditAchievement.aspx.cs" Inherits="OnlineHobby.EditAchievement" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Body" runat="server">
    ...
    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
        ...
        <div class="text-center">
            <h2 class="mt-5 pt-3 mb-3 pb-3" style="color: #f98006; font-weight: bold">Edit Achievement</h2>
        </div>
