<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EduReports.aspx.cs" Inherits="OnlineHobby.EduReports" MasterPageFile="~/StudMaster.Master"%>
            ...
            <table style="background-color: rgba(0, 0, 0, 0.03)">
                <tr>
                    ...
                    <td class="auto-style3" rowspan="4">
                        <asp:Button ID="btnViewTotalIncome" runat="server" CssClass="btn btn-light btn-lg rounded-pill" Text="VIEW" Style="height: 40px; width: 110px; background-color: #f98006; color: white" Font-Size="Medium" OnClick="btnViewTotalIncome_Click"  />
                ...
                <tr>
                    ...
                    <td dir="ltr" colspan="3" class="auto-style6">
                        <asp:Label ID="Label1" runat="server" Font-Size="17px" Text="Total Income Report"></asp:Label>
                    </td>
                    <td class="auto-style2">&nbsp;</td>
                    <td>&nbsp;</td>
