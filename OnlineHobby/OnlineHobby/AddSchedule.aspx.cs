    ...
    public partial class AddSchedule : System.Web.UI.Page
    {
        ...
        protected void btnAddSchedule_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                strQAddSchedule = "INSERT INTO [CourseSchedule](scheduleId, courseId, tutoringMode, meetingLink, maxStud, price, day, availability) VALUES (@ScheduleId, @CourseId, @TutoringMode, @MeetingLink, @MaxStud, @Price, @Day, @Availability)";
