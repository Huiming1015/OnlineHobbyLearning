    ...
    public partial class AddSchedule : System.Web.UI.Page
    {
        ...
        protected void btnAddSchedule_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                strQAddSchedule = "INSERT INTO [CourseSchedule](scheduleId, courseId, tutoringMode, meetingLink, maxStud, price, availability) VALUES (@ScheduleId, @CourseId, @TutoringMode, @MeetingLink, @MaxStud, @Price, @Availability)";
                SqlCommand comAdd= new SqlCommand(strQAddSchedule, con);
                comAdd.Parameters.AddWithValue("@ScheduleId", strScheduleID);
                comAdd.Parameters.AddWithValue("@CourseId", Session["CourseID"].ToString());
                comAdd.Parameters.AddWithValue("@TutoringMode", ddlTutoringMode.SelectedValue.ToString());
                ...
                {                   
                    ...
                    con = new SqlConnection(strCon);
                    con.Open();
                    strQAddList = "INSERT INTO [ScheduleList](scheduleListId, scheduleId, date, time) VALUES (@ScheduleListId, @ScheduleId, @Date, @Time)";
                    ...
                    comAddList.Parameters.AddWithValue("@Time", DateTime.Parse(txtTime.Text).ToShortTimeString());
        ...
        protected void btnNext_Click(object sender, EventArgs e)
        {
            ...
            com.Parameters.AddWithValue("@CourseId", Session["CourseID"].ToString());
            SqlDataReader dr = com.ExecuteReader();
            while (dr.Read())
            {
                count += 1;
