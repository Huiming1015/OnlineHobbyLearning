<%@ Page Title="" Language="C#" MasterPageFile="~/NestedProfile.master" AutoEventWireup="true" CodeBehind="EditPost.aspx.cs" Inherits="OnlineHobby.EditPost" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Body" runat="server">
    ...
    <div class="container-fluid div-background mt-3">
        <div class="alert alert-success alert-dismissible fade show" runat="server" id="MsgSuccess" visible="false">
            Post details updated successful.
    ...
    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
        ...
        <div class="text-center">
            <h2 class="mt-5 pt-3 mb-3 pb-3" style="color: #f98006; font-weight: bold">Edit Post</h2>
        </div>
