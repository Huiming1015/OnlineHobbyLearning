<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewMaterial.aspx.cs" Inherits="OnlineHobby.viewMaterial" %>
...
<body>
    <form id="form1" runat="server">
        <div class="text-center" style="background-position: center center; margin: 3%; background-repeat: repeat; background-attachment: fixed; font-size: 25px; border: 1px solid grey">
            <asp:DataList ID="dlMaterial" runat="server" DataKeyField="materialId" DataSourceID="SqlDataSource1" RepeatColumns="1" HorizontalAlign="Center" Width="100%" OnItemCommand="dlMaterial_ItemCommand">
                <ItemTemplate>
                    <table style="vertical-align: central;" class="auto-style1">
                        ...
                        <tr align="center">
                            ...
                            <td class="trRight" colspan="3">
                                <div align="right">
                                    <asp:Button ID="btnAddToCart" runat="server" CausesValidation="False" CssClass="btn btn-light btn-lg rounded-pill" OnClick="btnRemove_Click" OnClientClick="Confirm()" Style="height: 47px; width: 200px; background-color: #f98006; color: white" Text="ADD TO CART" CommandArgument='<%# Eval("materialId") %>' CommandName="addToCart" Visible="False" />
                                    &nbsp;<asp:Button ID="btnRemove" runat="server" CausesValidation="False" CssClass="btn btn-light btn-lg rounded-pill" OnClick="btnRemove_Click" OnClientClick="Confirm()" Style="height: 47px; width: 165px; background-color: #f98006; color: white" Text="REMOVE" CommandArgument='<%# Eval("materialId") %>' CommandName="remove" />
                                    &nbsp;<asp:Button ID="btnModify" runat="server" CausesValidation="False" CssClass="btn btn-light btn-lg rounded-pill" OnClick="btnModify_Click" Style="height: 47px; width: 165px; background-color: #f98006; color: white" Text="MODIFY" Width="163px" CommandArgument='<%# Eval("materialId") %>' CommandName="modify" />
                                </div>
                            </td>
                        </tr>
                    </table>
