<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TimetableStud.aspx.cs" Inherits="OnlineHobby.TimetableStud" MasterPageFile="~/StudMaster.Master"%>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container mt-2 mb-2 align-content-center" style="width: 90%; margin-left: 5%;">
        <div class="row g-0">
            <div class="col-md-2">
                <asp:Button ID="btnMyCourse" runat="server" Text="My Course" CssClass="border-1 w-100" BackColor="#FFF0E1" BorderColor="Black" Font-Size="Large" OnClick="btnMyCourse_Click" />
            </div>
            <div class="col-md-2">
