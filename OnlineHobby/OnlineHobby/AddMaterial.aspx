        ...
        <table style="background-color: #FFFFFF" align="center">
            ...
            <tr>
                <td rowspan="13" width="350px">
                    ...
                    <br />
                    <br />
                    <asp:FileUpload ID="imageUpload" runat="server" AllowMultiple="True" BorderStyle="None" Width="168px" onchange="ImagePreview(this);" Style="display: inline !important;" CssClass="form-control" />&nbsp;<span class="auto-style2"><br />
            ...
            <tr>
                ...
                <td style="font-size: large;" class="cssInputTr">
                    <asp:DropDownList ID="ddlCategory" runat="server" Width="250px" style="border-color:gainsboro; height:40px;">
            ...
            <tr>
                <td class="labelText" style="font-size: large;">&nbsp;</td>
                <td style="font-size: large;">&nbsp;</td>
                <td style="font-size: large;" class="cssInputTr">&nbsp;</td>
                <td style="font-size: large;">&nbsp;</td>
            </tr>
            <tr>
                ...
                <td style="font-size: large;" class="cssInputTr">
                    <asp:TextBox ID="txtDescription" runat="server" Height="103px" Width="459px" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="labelColumn" style="font-size: large;"><strong>:&nbsp;</strong></td>
                <td style="font-size: large;" class="cssInputTr">
                    <asp:TextBox ID="txtMaterialIncluded" runat="server" Height="76px" Width="458px" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="cssInputTr" style="font-size: large;">
                    <asp:TextBox ID="txtPrice" runat="server" CssClass="form-control" Width="184px"></asp:TextBox>
            ...
            <tr>
                ...
                <td style="font-size: large;" class="cssInputTr">
                    <div class="row">
                        <div class="col-md-5">
                            <asp:TextBox ID="txtStock" runat="server" CssClass="form-control" Width="191px"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                            <span>units</span>
                        </div>
